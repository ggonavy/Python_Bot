...
# --- STRATEGY PARAMETERS ---
initial_fiat_amount = 100  # e.g., $100
initial_total_btc = 10     # e.g., 10 BTC
...
# Pre-calculate fixed dollar amounts for buy ladder
buy_levels_amounts = [(level, initial_fiat_amount * percent) for level, percent in BUY_LADDER]
# Pre-calculate fixed BTC amounts for sell ladder
sell_levels_btc = [(level, initial_total_btc * percent) for level, percent in SELL_LADDER]
