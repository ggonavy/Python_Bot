...
CYCLE_INTERVAL = 90  # Increased to reduce API calls
MIN_USD_BALANCE = 100
HEALTH_CHECK_INTERVAL = 86400  # 24 hours
DEBUG_MODE = True
API_RATE_LIMIT_SLEEP = 150  # Increased for rate limits
...
def execute_trade(pair, side, price, volume, retries=5):
...
async def main():
    ...
    btc_price = 109259.90  # From latest log
    ...
    cache_duration = 900  # Cache OHLC for 15 minutes
