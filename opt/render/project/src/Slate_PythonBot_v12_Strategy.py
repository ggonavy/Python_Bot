...
CYCLE_INTERVAL = 60  # Increased to reduce API calls
MIN_USD_BALANCE = 100
HEALTH_CHECK_INTERVAL = 86400  # 24 hours
DEBUG_MODE = True
API_RATE_LIMIT_SLEEP = 120  # Increased for rate limits
...
async def main():
    ...
    btc_price = 109260.00  # From latest log
    ...
    cache_duration = 720  # Cache OHLC for 12 minutes
